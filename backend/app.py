...
# Average Effectiveness for Data Center
PUE = 1.5

# Average Carbon Intensity of the grid (kg CO2e per kWh)
# 0.82 is a recent the average carbon intensity for electricity generation in India was around 0.82 kilograms of CO2
...
def calculate_emissions():
    try:
        ...
        # calculation
        gpu_tdp_watts = GPU_TDP_DB.get(gpu_model, 300)
...
if __name__ == "__main__":
    # Runs server on http://127.0.0.1:5000
